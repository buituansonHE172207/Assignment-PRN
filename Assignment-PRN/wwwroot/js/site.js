...
document.addEventListener("DOMContentLoaded", function () {
    const connection = new signalR.HubConnectionBuilder()
        .withUrl("/signalr")
        .configureLogging(signalR.LogLevel.Information) // Optional: Adds logging for troubleshooting
    ...
    connection.onreconnecting(function (err) {
        console.warn("Connection lost due to error: " + err.toString() + ". Reconnecting...");
    });
